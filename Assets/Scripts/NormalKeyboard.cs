...
public class NormalKeyboard : ClickKeyboard
{
    ...
    private int[,,] keys = new int[6, 4, 6] { { { 0, ',', ',', 0x20, 0x20, 0x20 }, { 0x10, 'z', 'x', 'c', 'v', 'b' }, { 'a', 's', 'd', 'f', 'g', 'h' } ,{ 'q', 'w', 'e', 'r', 't', 'y'}},
                                              { { 0, ',', ',', 0x20, 0x20, 0x20 }, { 0x10, 'Z', 'X', 'C', 'V', 'B' }, { 'A', 'S', 'D', 'F', 'G', 'H' } ,{ 'Q', 'W', 'E', 'R', 'T', 'Y'}},
                                              { { 0, ',', ',', 0x20, 0x20, 0x20 }, { 0x10, '(', ')', '-', '_', ':' }, { '~', '!', '@', '#', '%', '\''} ,{ '1', '2', '3', '4', '5', '6'}},
