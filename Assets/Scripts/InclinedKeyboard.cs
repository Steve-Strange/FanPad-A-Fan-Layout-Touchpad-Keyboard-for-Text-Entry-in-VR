...
public class InclinedKeyboard : ClickKeyboard
{
    ...
    private int[,,] keys = new int[6, 6, 5]     { { { 0, 0, 0, 0, 0 }, {0x20, 'q', 0, 0, 0 }, {'a', 's','w' , 0, 0, }, {'.' ,'z' , 'x', 'd' , 'e'}, {',', 'c' ,'f' ,'r' , 0, }, { 'v' , 'g', 't' , 0, 0 } },
                                                  { { 0, 0, 0, 0, 0 }, {0x20, 'Q', 0, 0, 0 }, {'A', 'S','W' , 0, 0, }, {'.' ,'Z' , 'X', 'D' , 'E'}, {',', 'C' ,'F' ,'R' , 0, }, { 'V' , 'G', 'T' , 0, 0 } },
                                                  { { 0, 0, 0, 0, 0 }, {0x20, '1', 0, 0, 0 }, {'~', '!','2' , 0, 0, }, {'.' ,'(' , ')', '@' , '3'}, {',', '-' ,'#' ,'4' , 0, }, { '_' , '%', '5' , 0, 0 } },
